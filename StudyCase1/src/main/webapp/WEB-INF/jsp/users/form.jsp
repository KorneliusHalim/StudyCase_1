...
<a href="list" class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" >List Data</a>
&nbsp;<a href="../" class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" >Home</a>
