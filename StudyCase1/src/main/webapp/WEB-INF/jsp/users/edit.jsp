...
&nbsp;<a href="delete?id=${user.id}" class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" >Delete</a>
&nbsp;<a href="list" class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" >Back</a>
    			</div>
			</form>
    		</div>
